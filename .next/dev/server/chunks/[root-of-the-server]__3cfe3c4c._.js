...
"[project]/src/app/api/payments/checkout/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function getStripe() {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stripe$2f$esm$2f$stripe$2e$esm$2e$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](process.env.STRIPE_SECRET_KEY, {
...
async function POST(request) {
    try {
        ...
        const { data: founder } = await supabase.from('founders').select('id, email, full_name').eq('user_id', user.id).single();
        if (!founder) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3cfe3c4c._.js.map