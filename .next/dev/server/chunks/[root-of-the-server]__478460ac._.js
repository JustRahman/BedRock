...
"[project]/src/app/api/auth/complete-registration/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data: existingFounder } = await supabase.from('founders').select('id').eq('user_id', authUserId).single();
        if (existingFounder) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (founderError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Founder creation failed: ${founderError.message}`
            }, {
                status: 500
            });
        }
        ...
        if (trustScore && founderId) {
            ...
            const { status } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$trust$2d$score$2d$v2$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStatusFromScore"])(trustScore.score || 0);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__478460ac._.js.map