...
"[project]/src/app/api/verifications/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (founder.role === 'admin' && founderId) {
            const { data: verifications, error } = await supabase.from('founder_verifications').select('*').eq('founder_id', founderId).order('created_at', {
                ascending: false
            });
            if (error) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const { data: verifications, error } = await supabase.from('founder_verifications').select('*').eq('founder_id', founder.id).order('created_at', {
            ascending: false
        });
        if (error) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request) {
    try {
        ...
        const { data: verification, error } = await supabase.from('founder_verifications').upsert(upsertData, {
...
async function PATCH(request) {
    try {
        ...
        const { data: verification, error } = await supabase.from('founder_verifications').update(updateData).eq('id', body.verificationId).select().single();
        if (error) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: error.message
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__49e40a26._.js.map