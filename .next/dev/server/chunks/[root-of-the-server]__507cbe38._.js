...
"[project]/src/app/api/bank-applications/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!companyData) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Company not found. Complete LLC formation first.'
            }, {
                status: 400
            });
        }
        ...
        const { data: application, error } = await supabase.from('bank_applications').insert(insertData).select().single();
        if (error) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: error.message
            }, {
...
async function PATCH(request) {
    try {
        ...
        const targetId = founder.role === 'admin' && body.applicationId ? body.applicationId : body.id;
        let queryBuilder = supabase.from('bank_applications').update(updateData).eq('id', targetId);
        if (!(founder.role === 'admin' && body.applicationId)) {
            queryBuilder = queryBuilder.eq('founder_id', founder.id);
        }
        const { data: application, error } = await queryBuilder.select().single();
        if (error) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: error.message
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__507cbe38._.js.map