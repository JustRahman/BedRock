...
async function PUT(request) {
    try {
        ...
        // Get founder
        const { data: founderData } = await supabase.from('founders').select('id, email, full_name').eq('user_id', user.id).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__802bf645._.js.map