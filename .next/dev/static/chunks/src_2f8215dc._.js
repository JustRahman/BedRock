...
function BankAppsClient({ applications }) {
    ...
    const [noteInputs, setNoteInputs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const groups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BankAppsClient.useMemo[groups]": ()=>{
            ...
            return Array.from(map.values()).sort({
                "BankAppsClient.useMemo[groups]": (a, b)=>{
                    const aHasNew = a.apps.some({
                        "BankAppsClient.useMemo[groups].aHasNew": (app)=>app.status === 'submitted'
                    }["BankAppsClient.useMemo[groups].aHasNew"]);
                    const bHasNew = b.apps.some({
                        "BankAppsClient.useMemo[groups].bHasNew": (app)=>app.status === 'submitted'
                    }["BankAppsClient.useMemo[groups].bHasNew"]);
                    if (aHasNew !== bHasNew) return aHasNew ? -1 : 1;
                    const aInProgress = a.apps.some({
                        "BankAppsClient.useMemo[groups].aInProgress": (app)=>app.status === 'under_review'
                    }["BankAppsClient.useMemo[groups].aInProgress"]);
                    const bInProgress = b.apps.some({
                        "BankAppsClient.useMemo[groups].bInProgress": (app)=>app.status === 'under_review'
                    }["BankAppsClient.useMemo[groups].bInProgress"]);
    ...
    const handleStatusUpdate = async (appId, newStatus)=>{
        ...
        try {
            ...
            if (res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Status updated to ${getStatusConfig(newStatus).label}`);
                setNoteInputs((prev)=>({
                        ...prev,
                        [appId]: ''
                    }));
                                        ...
                                        children: group.apps.map((app)=>{
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                app.submittedAt && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                    className: "text-xs text-gray-400",
                                                                                    children: [
                                                                                        "Submitted ",
                                                                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(app.submittedAt), 'MMM d, yyyy')
                                                                                    ]
                                                                                }, void 0, true, {
                                                                                    fileName: "[project]/src/app/admin/bank-apps/bank-apps-client.tsx",
                                                                                    lineNumber: 346,
                                                                                ...
                                                                                app.approvedAt && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                    className: "text-xs text-green-600",
                                                                                    children: [
                                                                                        "Opened ",
                                                                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(app.approvedAt), 'MMM d, yyyy')
                                                                                    ]
                                                                                }, void 0, true, {
                                                                                    fileName: "[project]/src/app/admin/bank-apps/bank-apps-client.tsx",
                                                                                    lineNumber: 351,
                                                        ...
                                                        children: statusSteps.filter((s)=>s.key !== 'rejected').map((step, i)=>{
                                                            ...
                                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    i < statusSteps.filter((s)=>s.key !== 'rejected').length - 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    app.notes ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    app.status === 'rejected' && app.rejectionReason ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    (app.status === 'submitted' || app.status === 'under_review') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(BankAppsClient, "YJ02RBaX8aUXA/VDNPjQc+wQGyo=", false, function() {
    return [
...
//# sourceMappingURL=src_2f8215dc._.js.map