...
export function StepFinancial({ data, onNext, onBack }: StepFinancialProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onNext)} className="space-y-6">
      <div>
        <h3 className="text-lg font-medium text-gray-900">Financial Footprint</h3>
      ...
      <div className="rounded-lg border border-gray-200 p-6">
        <div className="text-center">
          ...
          <h4 className="mt-3 font-medium text-gray-900">Connect Stripe</h4>
      ...
      <div className="rounded-lg border border-gray-200 p-4">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <Label htmlFor="hasBankStatements" className="text-base font-medium">
